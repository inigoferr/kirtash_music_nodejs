    ...
    */
    $.ajax({url:'/checksignup',
            ...
            success: function(result){  
                ...
                if (result == -1){
                    $('#result').html("An error has ocurred, please try later");
                } else if (result == -2){
                    $('#result').html("Choose another username");
                } else if( result == -3){
                    $('#result').html("The passwords must be equal");
                } else if (result == -4){
                    $('#result').html("Fill all the boxes");
                }  else if (result == -5){
                    $('#result').html("The password must have at least 5 characters without spaces");
                }  else if (result == -6){
                    $('#result').html("The username must have at least 5 characters, without spaces");
                } else if (result == 1){
...
function checkSignIn(){
    ...
    $.ajax({url:'/checksignin',
            ...
            success: function(result){
                ...
                console.log(result);
                if (result == -1){
                    $('#result2').html("Username or password are not correct");
                } else if (result == 1){
                    let params = new URLSearchParams(location.search);
                    if (params.get('id_session') != null){
...
function createSession(){
    ...
    $.ajax({
        url: "/create_session",
        data: {name_session: $('#name_session').val(),pass_session:$('#pass_session').val(),pass_session2:$('#pass_session2').val(),
